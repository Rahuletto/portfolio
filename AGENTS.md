...
interface ManicConfig {
  ...
  router?: { viewTransitions?: boolean; preserveScroll?: boolean; scrollBehavior?: "auto" | "smooth" };
  build?: { minify?: boolean; sourcemap?: boolean | "inline" | "external"; splitting?: boolean; outdir?: string };
...
interface SwaggerConfig {
  path?: string;
  documentation?: { info?: { title?: string; description?: string; version?: string } };
}
