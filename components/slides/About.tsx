...
const WipeIcon = dynamic(
  () => import("@/misc/WipeText").then((a) => a.WipeIcon),
  { ssr: true }
);
const WipeWord = dynamic(
  () => import("@/misc/WipeText").then((a) => a.WipeWord),
  { ssr: true }
);
...
const LuLaptop = dynamic(
  () => import("react-icons/lu").then((a) => a.LuLaptop),
  { ssr: false }
);
const HiOutlinePaintBrush = dynamic(
  () => import("react-icons/hi2").then((a) => a.HiOutlinePaintBrush),
  { ssr: false }
);
const LiaDumbbellSolid = dynamic(
  () => import("react-icons/lia").then((a) => a.LiaDumbbellSolid),
  { ssr: false }
);
const IoConstruct = dynamic(
  () => import("react-icons/io5").then((a) => a.IoConstruct),
  { ssr: false }
);
const FaUniversalAccess = dynamic(
  () => import("react-icons/fa6").then((a) => a.FaUniversalAccess),
  { ssr: false }
);
const FaWandMagicSparkles = dynamic(
  () => import("react-icons/fa6").then((a) => a.FaWandMagicSparkles),
  { ssr: false }
);
