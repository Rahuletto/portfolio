export function HeroSection() {
  return (
    <section className="hero relative z-[1] min-h-svh isolate bg-transparent" id="top">
      ...
      <h1 className="hero-title hero-copy hero-copy--statement absolute bottom-[14vh] left-[5.8vw] z-[3] m-0 max-w-[52vw] text-[clamp(42px,3.8vw,70px)] leading-[.98] font-semibold tracking-[-.04em] max-[760px]:bottom-[12vh] max-[760px]:left-[18px] max-[760px]:max-w-[calc(100vw-36px)] max-[760px]:text-[13vw]">
