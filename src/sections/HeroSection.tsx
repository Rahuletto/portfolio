  ...
  return (
    <section className="hero relative z-[1] min-h-svh isolate bg-transparent" id="top">
      <div className="hero-meta absolute top-[7vh] right-[5.8vw] left-[5.8vw] z-[2] grid grid-cols-[2.3fr_1fr] items-start gap-[5vw] text-white/78 max-[760px]:top-[6vh] max-[760px]:right-[18px] max-[760px]:left-[18px] max-[760px]:block">
        <h2 className="hero-copy hero-copy--eyebrow m-0 text-[clamp(17px,1.4vw,26px)] leading-none font-medium tracking-[-.025em] max-[760px]:hidden">
      ...
      <h1 className="hero-title hero-copy hero-copy--statement absolute bottom-[14vh] left-[5.8vw] z-[3] m-0 max-w-[52vw] text-[clamp(42px,3.8vw,70px)] leading-[1.05] font-semibold tracking-[-.04em] max-[760px]:bottom-[12vh] max-[760px]:left-[18px] max-[760px]:max-w-[calc(100vw-36px)] max-[760px]:text-[13vw]">
